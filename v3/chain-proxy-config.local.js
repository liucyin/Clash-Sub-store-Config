...
function main(config, profileName) {
  ...
  if (hasHomeProxies) {
    const aiGroups = ["指纹浏览器-1-7911", "指纹浏览器-2-7912", "指纹浏览器-3-7913", "手动选择", "GLOBAL", "Apple", "AppStore", "BiliBili", "Claude", "Cursor", "Disney", "Emby", "Gemini", "Grok", "Perplexity", "Github", "Google", "Microsoft", "Netflix", "OpenAI", "OneDrive", "Steam", "Spotify", "TikTok", "Telegram", "Twitter", "YouTube", "漏网之鱼"]
